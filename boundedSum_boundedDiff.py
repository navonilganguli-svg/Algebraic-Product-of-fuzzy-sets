...
# Bounded Sum
@validator
def bounded_sum(set1: dict[str, float],
...
# Bounded Difference
@validator
def bounded_difference(set1: dict[str, float],
                       set2: dict[str, float]) -> dict[str, float]:
...
if __name__ == "__main__":
    ...
    try:
        ...
        sum_result = bounded_sum(
            fuzzy_set1,
            fuzzy_set2
        )

        diff_result = bounded_difference(
            fuzzy_set1,
            fuzzy_set2
        )
